...
describe('permissions catalog', () => {
  ...
  it('keeps owner template as full catalog', () => {
    ...
    expect(SYSTEM_ROLE_TEMPLATES.sales.permissions).toContain('leads.manage')
    ...
    expect(SYSTEM_ROLE_TEMPLATES.supervisor.permissions).toContain('telegram.send')
    expect(SYSTEM_ROLE_TEMPLATES.supervisor.permissions).not.toContain('leads.manage')
  })
})
