  ...
  if (role === 'field_worker') {
    return msg(locale, {
      en: [
        ...
        'Feed: Broiler A · Vaccinate: Broiler A · Mortality: Broiler A heads=3',
        '',
  ...
  return [
    ...
    msg(locale, {
      en: [
        ...
        'Livestock: Broiler A species=broiler heads=200',
        'Stock: Feed bags delta=-2 reason=used',
        'Opening count: Feed bags=50',
        'Ack low stock',
        ...
        'Feed: Broiler A · Vaccinate: … · Mortality: Broiler A heads=3',
        '',
