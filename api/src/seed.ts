...
async function seed() {
  ...
  console.log('  owner@trovara.farm          (BREAK_GLASS_PASSWORD)')
  console.log('  admin@trovara.farm          (SEED_OWNER_PASSWORD) — day-to-day Admin')
  console.log('  auditor@trovara.farm        (SEED_SUPERVISOR_PASSWORD) — custom Auditor role')
