...
const enPages: Record<string, PageGuide> = {
  ...
  '/newsletter': {
    summary: 'See confirmed subscribers, send farm emails, and review campaign delivery history.',
    actions: ['Confirm the audience count before sending.', 'Use product availability only for people who joined that exact waitlist.', 'Respect an unsubscribe request immediately.'],
  },
  '/marketing-leads': {
...
const pcmPages: Record<string, PageGuide> = {
  ...
  '/journal': { summary: 'Write and publish story for public farm journal.', actions: ['Keep am as draft until words and picture ready.', 'Preview the story before you publish am.'] },
  ...
  '/newsletter': { summary: 'See confirmed subscriber, send farm email and check campaign delivery history.', actions: ['Confirm audience number before you send.', 'Send product availability only to people wey join that exact waitlist.', 'Respect unsubscribe request quick.'] },
...
const yoPages: Record<string, PageGuide> = {
  ...
  '/journal': { summary: 'Kọ àti tẹ ìtàn jáde fún Journal oko tí gbogbo ènìyàn lè kà.', actions: ['Fi sí draft títí ọ̀rọ̀ àti àwòrán fi pé.', 'Wo ìtàn náà kí o tó tẹ̀ ẹ́ jáde.'] },
  ...
  '/newsletter': { summary: 'Wo àwọn alabapin tí a fọwọ́sí, fi imeeli oko ránṣẹ́, kí o sì tọ́pa ìfijiṣẹ́ ipolongo.', actions: ['Jẹ́rìí iye olùgbà kí o tó ránṣẹ́.', 'Fi ìròyìn wiwa ọja ránṣẹ́ sí àwọn tó darapọ̀ mọ́ waitlist ọja yẹn nìkan.', 'Bọwọ́ fún ìbéèrè láti dá imeeli dúró lẹ́sẹ̀kẹsẹ̀.'] },
...
const frPages: Record<string, PageGuide> = {
  ...
  '/journal': { summary: 'Rédigez et publiez les articles du journal public de la ferme.', actions: ['Gardez le brouillon tant que le texte ou les images ne sont pas prêts.', 'Prévisualisez l’article avant de le publier.'] },
  ...
  '/newsletter': { summary: 'Consultez les abonnés confirmés, envoyez les emails de la ferme et suivez les campagnes.', actions: ['Confirmez le nombre de destinataires avant l’envoi.', 'Réservez les alertes produit aux personnes inscrites à la liste d’attente correspondante.', 'Appliquez immédiatement toute demande de désinscription.'] },
